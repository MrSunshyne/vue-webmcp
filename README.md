...
| package | what it is |
| --- | --- |
| [`vue-webmcp`](packages/vue-webmcp) | The composables: `useWebMCPTool()` to register a tool, `useRegisteredTools()` to discover and call them. Vue 3.3+, SSR-safe, no runtime dependencies. |
